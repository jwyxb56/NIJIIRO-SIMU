	...
	internal class CStage曲読み込み : CStage
	{
		...
		public override void On活性化()
		{
			...
			try
			{
                ...
                this.strDANSTAGEFILE = CSkin.Path(@"Graphics\4_SongLoading\Dan_Background.png");
		...
		public override void OnManagedリソースの解放()
		{
			if( !base.b活性化してない )
			{
                ...
                TJAPlayer3.tテクスチャの解放( ref this.tx段位背景);
		...
		public override int On進行描画()
		{
            ...
            {
                if (this.tx段位背景 != null)
                    this.tx段位背景.t2D描画(TJAPlayer3.app.Device, 0, 0);
            }
            if (TJAPlayer3.stage選曲.n現在選択中の曲の難易度 != (int)Difficulty.Dan)
            {
                this.ct曲名表示.t進行();
