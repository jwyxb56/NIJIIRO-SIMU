		...
		public int t進行描画( int x, int y )
		{
			...
			if( !base.b活性化してない && !this.bMute )
			{
                ...
                else
                {
                    ...
                    {
                        if (TJAPlayer3.Tx.Taiko_Stage_Text != null)
                        {
                            ...
                            if (this.ct進行用.n現在の値 < 745)
                            {
                                ...
                                TJAPlayer3.Tx.Taiko_Stage_Text.n透明度 = 0;
                            ...
                            else if (this.ct進行用.n現在の値 >= 745 && this.ct進行用.n現在の値 < 1000)
                            {
                                ...
                                TJAPlayer3.Tx.Taiko_Stage_Text.n透明度 = this.ct進行用.n現在の値 - 745;
                                this.tx難易度とステージ数.n透明度 = 0;
                            }
                            else if (this.ct進行用.n現在の値 >= 1000 && this.ct進行用.n現在の値 <= 1745)
                            {
                                ...
                                if (this.txGENRE != null)
                                    this.txGENRE.n透明度 = 0;
                                TJAPlayer3.Tx.Taiko_Stage_Text.n透明度 = 255;
                            }
                            else if (this.ct進行用.n現在の値 >= 1745)
                            {
                                ...
                                TJAPlayer3.Tx.Taiko_Stage_Text.n透明度 = 255 - (this.ct進行用.n現在の値 - 1745);
                            }
                        }
                        else if (this.tx難易度とステージ数 != null)
                        {
                            if (this.ct進行用.n現在の値 < 745)
                            {
                                this.bFirst = false;
                    ...
                    if (TJAPlayer3.stage選曲.n確定された曲の難易度 != (int)Difficulty.Dan)
                    {
                        if (TJAPlayer3.Tx.Taiko_Stage_Text != null)
                        {
                            TJAPlayer3.Tx.Taiko_Stage_Text.t2D描画(TJAPlayer3.app.Device, 1270 - TJAPlayer3.Tx.Taiko_Stage_Text.szテクスチャサイズ.Width, 14);
                        }
                        else if (this.tx難易度とステージ数 != null)
                        {
                            this.tx難易度とステージ数.t2D描画(TJAPlayer3.app.Device, 1270 - this.tx難易度とステージ数.szテクスチャサイズ.Width, 14);
                        }
                    }
                    else
                    {
