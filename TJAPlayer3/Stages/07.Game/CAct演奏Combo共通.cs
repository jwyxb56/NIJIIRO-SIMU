...
namespace TJAPlayer3
{
    ...
    protected float[,] nコンボ拡大率_座標_1000combo = new float[,]{
        ...
        public float[,] ComboScale_Ex = new float[,]
        {
            { 0.000f, 0},
            { 0.072f, -1},
            { 0.144f, -2},
        ...
        protected virtual void tコンボ表示_太鼓(int nCombo値, int nジャンプインデックス, int nPlayer)
        {
            ...
            if (n桁数 <= 2)
            {
                ...
                {
                    TJAPlayer3.Tx.Taiko_Combo_Text_Old?.t2D描画(TJAPlayer3.app.Device, 212, 268, new Rectangle(0, 0, 72, 30));
                }
            }
            else
            {
                ...
                {
                    TJAPlayer3.Tx.Taiko_Combo_Text_Old?.t2D描画(TJAPlayer3.app.Device, 212, 268, new Rectangle(0, 30, 72, 30));
                }
            }
                #endregion
            ...
            for (int i = 0; i < n桁数; i++)
            {
                ...
                if (n桁数 <= 1)
                {
                    ...
                    else
                    {
                        ...
                        {
                            var yScalling = ComboScale[this.ctコンボ加算[nPlayer].n現在の値];
                            TJAPlayer3.Tx.Taiko_Combo[2].vc拡大縮小倍率.Y = 1 + yScalling;
                            TJAPlayer3.Tx.Taiko_Combo[2].vc拡大縮小倍率.X = 1;
                            TJAPlayer3.Tx.Taiko_Combo[2].t2D拡大率考慮下中心基準描画(TJAPlayer3.app.Device, rightX, 265, new Rectangle(n位の数[i] * 44, 0, 44, 50));
                        }
                    }
                }
                else if (n桁数 <= 2)
                {
                    ...
                    else
                    {
                        if (TJAPlayer3.Tx.Taiko_Combo[2] != null)
                        {
                            ...
                            TJAPlayer3.Tx.Taiko_Combo[2].vc拡大縮小倍率.Y = 1 + yScalling;
                            TJAPlayer3.Tx.Taiko_Combo[2].vc拡大縮小倍率.X = 1;
                            TJAPlayer3.Tx.Taiko_Combo[2].t2D拡大率考慮下中心基準描画(TJAPlayer3.app.Device, rightX - 40 * i, 265, new Rectangle(n位の数[i] * 44, 0, 44, 50));
                        }
                    }
                }
                else if (n桁数 == 3)
                {
                    ...
                    {
                        if (TJAPlayer3.Tx.Taiko_Combo[3] != null)
                        {
                            var yScalling = ComboScale_Ex[this.ctコンボ加算[nPlayer].n現在の値, 0];
                            TJAPlayer3.Tx.Taiko_Combo[3].vc拡大縮小倍率.Y = 1 + yScalling;
                            TJAPlayer3.Tx.Taiko_Combo[3].vc拡大縮小倍率.X = 1;
                            var yJumping = TJAPlayer3.Skin.Game_Taiko_Combo_Ex_IsJumping ? (int)ComboScale_Ex[this.ctコンボ加算[nPlayer].n現在の値, 1] : 0;
                            TJAPlayer3.Tx.Taiko_Combo[3].t2D拡大率考慮下中心基準描画(TJAPlayer3.app.Device, rightX - 47 * i, 270 + yJumping, new Rectangle(n位の数[i] * 50, 0, 50, 65));
                        }
                        if (TJAPlayer3.Tx.Taiko_Combo_Effect != null)
                        {
                            TJAPlayer3.Tx.Taiko_Combo_Effect.b加算合成 = true;
                            if (this.ctコンボラメ.n現在の値 < 14)
                            {
                                ...
                                #endregion
                                TJAPlayer3.Tx.Taiko_Combo_Effect.t2D拡大率考慮下中心基準描画(TJAPlayer3.app.Device, (rightX - 47 * i) - ((50 / 4) * 1), 260 - ((65 / 4) * 1) - (int)(1.05 * this.ctコンボラメ.n現在の値));
                            }
                            if (ctコンボラメ.n現在の値 > 4 && ctコンボラメ.n現在の値 < 24)
                            {
                                // みぎ
                            ...
                            if (ctコンボラメ.n現在の値 > 14)
                            {
                                ...
                                #endregion
                                TJAPlayer3.Tx.Taiko_Combo_Effect.t2D拡大率考慮下中心基準描画(TJAPlayer3.app.Device, (rightX - 47 * i), 260 - ((65 / 4) * 1) - (int)(1.05 * this.ctコンボラメ.n現在の値));
                            }
                        }
                    }
                }
                else
                {
                    ...
                    else
                    {
                        ...
                        {
                            var yScalling = ComboScale_Ex[this.ctコンボ加算[nPlayer].n現在の値, 0];
                            TJAPlayer3.Tx.Taiko_Combo[3].vc拡大縮小倍率.Y = 0.866f + yScalling;
                            TJAPlayer3.Tx.Taiko_Combo[3].vc拡大縮小倍率.X = 0.866f;
                            var yJumping = TJAPlayer3.Skin.Game_Taiko_Combo_Ex_IsJumping ? (int)ComboScale_Ex[this.ctコンボ加算[nPlayer].n現在の値, 1] : 0;
                            TJAPlayer3.Tx.Taiko_Combo[3].t2D拡大率考慮下中心基準描画(TJAPlayer3.app.Device, rightX - 39 * i, 266 + yJumping, new Rectangle(n位の数[i] * 50, 0, 50, 65));
                        }
                        if (TJAPlayer3.Tx.Taiko_Combo_Effect != null)
                        {
                            TJAPlayer3.Tx.Taiko_Combo_Effect.b加算合成 = true;
                            if (this.ctコンボラメ.n現在の値 < 14)
                            {
                                ...
                                #endregion
                                TJAPlayer3.Tx.Taiko_Combo_Effect.t2D拡大率考慮下中心基準描画(TJAPlayer3.app.Device, (rightX - 39 * i) - ((50 / 4) * 0.866f), 256 - ((65 / 4) * 0.866f) - (int)(1.05 * this.ctコンボラメ.n現在の値));
                            }
                            if (ctコンボラメ.n現在の値 > 4 && ctコンボラメ.n現在の値 < 24)
                            {
                                // みぎ
                            ...
                            if (ctコンボラメ.n現在の値 > 14)
                            {
                                ...
                                #endregion
                                TJAPlayer3.Tx.Taiko_Combo_Effect.t2D拡大率考慮下中心基準描画(TJAPlayer3.app.Device, (rightX - 39 * i), 256 - ((65 / 4) * 0.866f) - (int)(1.05 * this.ctコンボラメ.n現在の値));
		...
		public override int On進行描画()
		{
			...
			for( int i = 0; i < 4; i++ )
			{
                ...
                if (TJAPlayer3.ConfigIni.ChangeNewSkin == true)
                {
                    ...
                    else if ((this.status[i].n現在表示中のCOMBO値 < 3) && (this.status[i].nCOMBO値 < 3))
                    {
                ...
                else
                {
                    ...
                    else if ((this.status[i].n現在表示中のCOMBO値 < 10) && (this.status[i].nCOMBO値 < 10))
                    {
                        e今回の状態遷移イベント = EEvent.非表示;
                    }
                    else
