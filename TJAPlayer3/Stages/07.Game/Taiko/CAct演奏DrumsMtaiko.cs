      ...
      //      }
        ...
        public override int On進行描画()
        {
            ...
            else
            {
                ...
                {
                    if (TJAPlayer3.Tx.Taiko_Background[3] != null)
                    {
                        TJAPlayer3.Tx.Taiko_Background[3].t2D描画(TJAPlayer3.app.Device, 0, 184);
                    }
                }
                else if (TJAPlayer3.ConfigIni.Change2PSkin == false)
                {
            ...
            if (TJAPlayer3.ConfigIni.ChangeNewSkin == true)
            {
            ...
            {
                if (TJAPlayer3.Tx.Taiko_Base_Old != null)
                {
                    TJAPlayer3.Tx.Taiko_Base_Old.t2D描画(TJAPlayer3.app.Device, 172, 183);
                }
            }
            if (TJAPlayer3.ConfigIni.ChangeNewSkin == true)
            {
            ...
            {
                if (TJAPlayer3.Tx.Taiko_Don_Left_Old != null && TJAPlayer3.Tx.Taiko_Don_Right_Old != null && TJAPlayer3.Tx.Taiko_Ka_Left_Old != null && TJAPlayer3.Tx.Taiko_Ka_Right_Old != null)
                {
                    TJAPlayer3.Tx.Taiko_Ka_Left_Old.n透明度 = this.stパッド状態[0].n明るさ * 73;
                    TJAPlayer3.Tx.Taiko_Ka_Right_Old.n透明度 = this.stパッド状態[1].n明るさ * 73;
                    TJAPlayer3.Tx.Taiko_Don_Left_Old.n透明度 = this.stパッド状態[2].n明るさ * 73;
                    TJAPlayer3.Tx.Taiko_Don_Right_Old.n透明度 = this.stパッド状態[3].n明るさ * 73;

                    TJAPlayer3.Tx.Taiko_Ka_Left_Old.t2D描画(TJAPlayer3.app.Device, 172, 183, new Rectangle(0, 0, TJAPlayer3.Tx.Taiko_Ka_Right_Old.szテクスチャサイズ.Width / 2, TJAPlayer3.Tx.Taiko_Ka_Right_Old.szテクスチャサイズ.Height));
                    TJAPlayer3.Tx.Taiko_Ka_Right_Old.t2D描画(TJAPlayer3.app.Device, 172 + TJAPlayer3.Tx.Taiko_Ka_Right_Old.szテクスチャサイズ.Width / 2, 183, new Rectangle(TJAPlayer3.Tx.Taiko_Ka_Right_Old.szテクスチャサイズ.Width / 2, 0, TJAPlayer3.Tx.Taiko_Ka_Right_Old.szテクスチャサイズ.Width / 2, TJAPlayer3.Tx.Taiko_Ka_Right_Old.szテクスチャサイズ.Height));
                    TJAPlayer3.Tx.Taiko_Don_Left_Old.t2D描画(TJAPlayer3.app.Device, 172, 183, new Rectangle(0, 0, TJAPlayer3.Tx.Taiko_Ka_Right_Old.szテクスチャサイズ.Width / 2, TJAPlayer3.Tx.Taiko_Ka_Right_Old.szテクスチャサイズ.Height));
                    TJAPlayer3.Tx.Taiko_Don_Right_Old.t2D描画(TJAPlayer3.app.Device, 172 + TJAPlayer3.Tx.Taiko_Ka_Right_Old.szテクスチャサイズ.Width / 2, 183, new Rectangle(TJAPlayer3.Tx.Taiko_Ka_Right_Old.szテクスチャサイズ.Width / 2, 0, TJAPlayer3.Tx.Taiko_Ka_Right_Old.szテクスチャサイズ.Width / 2, TJAPlayer3.Tx.Taiko_Ka_Right_Old.szテクスチャサイズ.Height));
                }
            }
            if( TJAPlayer3.Tx.Taiko_Don_Left != null && TJAPlayer3.Tx.Taiko_Don_Right != null && TJAPlayer3.Tx.Taiko_Ka_Left != null && TJAPlayer3.Tx.Taiko_Ka_Right != null )
            {
            ...
            for( int i = 0; i < TJAPlayer3.ConfigIni.nPlayerCount; i++ )
            {
                ...
                {
                    if (TJAPlayer3.Tx.Couse_Symbol_Dan[TJAPlayer3.stage選曲.n確定された曲の難易度] != null)
                    {
                        TJAPlayer3.Tx.Couse_Symbol_Dan[TJAPlayer3.stage選曲.n確定された曲の難易度].t2D描画(TJAPlayer3.app.Device,
                            -6,
                            232
                            );
                    }
                ...
                if (TJAPlayer3.ConfigIni.真打)
                {
                    ...
                    {
                        if (TJAPlayer3.Tx.Couse_Symbol_Dan[(int)Difficulty.Total] != null)
                        {
                            TJAPlayer3.Tx.Couse_Symbol_Dan[(int)Difficulty.Total].t2D描画(TJAPlayer3.app.Device,
                                -6,
                                232
                                );
                        }
            ...
            if (TJAPlayer3.ConfigIni.ChangeNewSkin == true)
            {
                ...
                if (TJAPlayer3.ConfigIni.Change2PSkin == true)
                {
                    if (TJAPlayer3.Tx.Taiko_PlayerNumber[2] != null)
                    {
                        TJAPlayer3.Tx.Taiko_PlayerNumber[2].t2D描画(TJAPlayer3.app.Device, TJAPlayer3.Skin.Game_Taiko_PlayerNumber_X[0], TJAPlayer3.Skin.Game_Taiko_PlayerNumber_Y[0]);
                    }
                }
                else if (TJAPlayer3.ConfigIni.Change2PSkin == false)
                {
                ...
                {
                    this.ctプレートエフェクト.t進行Loop();
                    TJAPlayer3.Tx.PlateEffect[this.ctプレートエフェクト.n現在の値].t2D描画(TJAPlayer3.app.Device, TJAPlayer3.Skin.Game_Taiko_PlateEffect_X[0], TJAPlayer3.Skin.Game_Taiko_PlateEffect_Y[0]);
                }
                if (TJAPlayer3.stage演奏ドラム画面.bDoublePlay && TJAPlayer3.Tx.PlateEffect != null)
                {
                    this.ctプレートエフェクト.t進行Loop();
                    TJAPlayer3.Tx.PlateEffect[this.ctプレートエフェクト.n現在の値].t2D描画(TJAPlayer3.app.Device, TJAPlayer3.Skin.Game_Taiko_PlateEffect_X[1], TJAPlayer3.Skin.Game_Taiko_PlateEffect_Y[1]);
                }

                if (TJAPlayer3.Tx.Taiko_PlateText != null)
                {
                    TJAPlayer3.Tx.Taiko_PlateText.t2D描画(TJAPlayer3.app.Device, TJAPlayer3.Skin.Game_Taiko_NamePlate_X[0], TJAPlayer3.Skin.Game_Taiko_NamePlate_Y[0]);
                }
            }
            if (TJAPlayer3.ConfigIni.ChangeNewSkin == false)
            {
                TJAPlayer3.Tx.NamePlate[0]?.t2D描画(TJAPlayer3.app.Device, 297, 19);
                TJAPlayer3.Tx.Taiko_PlateText?.t2D描画(TJAPlayer3.app.Device, 297+83, 19);
            }
