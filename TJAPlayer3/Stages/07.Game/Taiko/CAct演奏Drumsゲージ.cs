			...
			if ( !base.b活性化してない )
			{
                ...
                */
                ...
                if (TJAPlayer3.stage選曲.n現在選択中の曲の難易度 != (int)Difficulty.Dan)
                {
                    ...
                    {
                        if (TJAPlayer3.Tx.Gauge_Base[3] != null)
                        {
                            TJAPlayer3.Tx.Gauge_Base[3].t2D描画(TJAPlayer3.app.Device, 492, 144, new Rectangle(0, 0, 700, 44));
                        }
                    }
                    else
                    {
                ...
                else if (TJAPlayer3.stage選曲.n現在選択中の曲の難易度 == (int)Difficulty.Dan)
                {
                    if (TJAPlayer3.ConfigIni.Change2PSkin == true)
                    {
                        if (TJAPlayer3.Tx.Gauge_Base[4] != null)
                        {
                            TJAPlayer3.Tx.Gauge_Base[4].t2D描画(TJAPlayer3.app.Device, 492, 144, new Rectangle(0, 0, 700, 44));
                        }
                    }
                    else
                    {
                        if (TJAPlayer3.Tx.Gauge_Base[2] != null)
                        {
                ...
                if (TJAPlayer3.stage選曲.n確定された曲の難易度 != (int)Difficulty.Dan)
                {
                        ...
                        if (TJAPlayer3.ConfigIni.Change2PSkin == true)
                        {
                            if (TJAPlayer3.Tx.Gauge[4] != null)
                            {
                                TJAPlayer3.Tx.Gauge[4].t2D描画(TJAPlayer3.app.Device, 492, 144, new Rectangle(0, 0, nRectX, 44));
                            }
                        }
                        else
                        {
                ...
                else if(TJAPlayer3.stage選曲.n現在選択中の曲の難易度 == (int)Difficulty.Dan)
                {
                    if (TJAPlayer3.ConfigIni.Change2PSkin == true)
                    {
                        if (TJAPlayer3.Tx.Gauge[5] != null)
                        {
                            TJAPlayer3.Tx.Gauge[5].t2D描画(TJAPlayer3.app.Device, 492, 144, new Rectangle(0, 0, nRectX, 44));
                        }
                    }
                    else
                    {
                        if (TJAPlayer3.Tx.Gauge[2] != null)
                        {
                    ...
                    if (TJAPlayer3.Tx.Gauge_Line[0] != null)
                    {
                        if (this.db現在のゲージ値[0] >= 100.0)
                        {
                            this.ct虹アニメ.t進行Loop();
                            this.ct虹透明度.t進行Loop();
                            if (TJAPlayer3.Tx.Gauge_Rainbow_Dan[this.ct虹アニメ.n現在の値] != null)
                            {
                                TJAPlayer3.Tx.Gauge_Rainbow_Dan[this.ct虹アニメ.n現在の値].n透明度 = 255;
                                TJAPlayer3.Tx.Gauge_Rainbow_Dan[this.ct虹アニメ.n現在の値].t2D描画(TJAPlayer3.app.Device, 492, 144);
                                TJAPlayer3.Tx.Gauge_Rainbow_Dan[虹ベース].n透明度 = (ct虹透明度.n現在の値 * 255 / ct虹透明度.n終了値) / 1;
                                TJAPlayer3.Tx.Gauge_Rainbow_Dan[虹ベース].t2D描画(TJAPlayer3.app.Device, 492, 144);
                            }
                        }
                        TJAPlayer3.Tx.Gauge_Line[0].t2D描画(TJAPlayer3.app.Device, 492, 144);
                    }
