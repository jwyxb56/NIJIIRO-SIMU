...
namespace TJAPlayer3
{
	internal class CActConfigList : CActivity
	{
		...
		public void t項目リストの設定_System()
		{
            ...
            ChangeNewSkin = new CItemToggle("ChangeNewSkin", TJAPlayer3.ConfigIni.ChangeNewSkin,
                "新スキンを使用するかどうか\n" +
                "ONにすると新スキンを使用する\n" +
                "OFFにすると旧スキンを使用する\n" +
                "");
            this.list項目リスト.Add(ChangeNewSkin);

            Change2PSkin = new CItemToggle("Change2PSkin", TJAPlayer3.ConfigIni.Change2PSkin,
                "2Pスキンを使用するかどうか\n" +
                "ONにすると2Pスキンを使用する\n" +
                "OFFにすると1Pスキンを使用する\n" +
                "");
            this.list項目リスト.Add(Change2PSkin);
		...
		public void t項目リストの設定_Drums()
		{
            ...
            ShinuchiMode = new CItemToggle(nameof(ShinuchiMode), TJAPlayer3.ConfigIni.真打, CItemBase.Eパネル種別.通常,
                "真打モードを有効にする。",
...
//		private CItemBase iCommonReturnToMenu;
        ...
        CItemToggle ChangeNewSkin;
        CItemToggle Change2PSkin;
...
//			CDTXMania.ConfigIni.nASIOBufferSizeMs = this.iSystemASIOBufferSizeMs.n現在の値;					// #24820 2013.1.3 yyagi
            ...
            TJAPlayer3.ConfigIni.ChangeNewSkin = this.ChangeNewSkin.bON;
            TJAPlayer3.ConfigIni.Change2PSkin = this.Change2PSkin.bON;
		...
		private void tConfigIniへ記録する_Drums()
		{
            ...
            TJAPlayer3.ConfigIni.真打 = this.ShinuchiMode.bON;
