...
//                    }
        ...
        public Cシステムサウンド sound結果発表 = null;
        ...
        public Cシステムサウンド this[Eシステムサウンド sound]
        {
            get
            {
                switch (sound)
                {
                    ...
                    case Eシステムサウンド.SOUND結果発表:
                        return this.sound結果発表;
                }
        ...
        public void PrepareReloadSkin()
        {
            ...
            this.sound結果発表 = new Cシステムサウンド(@"Sounds\ResultIn_Dan.ogg", false, false, false, ESoundGroup.Voice);
            this.sound段位チャレンジ選択音 = new Cシステムサウンド(@"Sounds\Dan_Select.wav", false, false, false, ESoundGroup.Voice);
            ReloadSkin();
            tReadSkinConfig();
        }
        ...
        internal int Game_Background_Ptn_Kame;
        ...
        public int Font_Edge_Ratio = 1;
        public int Font_Edge_Ratio_Vertical = 1;
        ...
        public int PlateEffect_Ptn;
        public int PlateEffect_Timer = 32;
        #endregion
        #region Config
        ...
        public int[] SongSelect_PlateEffect_X = new int[] { 90, 950 };
        public int[] SongSelect_PlateEffect_Y = new int[] { 606, 650 };
        ...
        public int[] Game_Taiko_PlateEffect_X = new int[] { -35, 0 };
        public int[] Game_Taiko_PlateEffect_Y = new int[] { 254, 368 };
        ...
        public int[] Result_Hit_X = new int[] { 1144, 1144 };
        public int[] Result_Hit_Y = new int[] { 264, 564 };
        ...
        public int[] Result_CourseSymbol_X = new int[] { 305, 305 };
        public int[] Result_CourseSymbol_Y = new int[] { 160, 460 };
        public int[] Result_In_X = new int[] { 0, 0 };
        public int[] Result_In_Y = new int[] { 5, 305 };
        public int[] Result_Normal_Loop_X = new int[] { -45, -45 };
        public int[] Result_Normal_Loop_Y = new int[] { 132, 432 };
        public int[] Result_Oukan_X = new int[] { 395, 395 };
        public int[] Result_Oukan_Y = new int[] { 225, 525 };
        public int[] Result_Failed_Loop_X = new int[] { 0, 0 };
        public int[] Result_Failed_Loop_Y = new int[] { 135, 435 };
        public int[] Result_Clear_Loop_X = new int[] { 0, 0 };
        public int[] Result_Clear_Loop_Y = new int[] { 30, 330 };
        public int[] Result_Daiseikou_In_X = new int[] { 0, 0 };
        public int[] Result_Daiseikou_In_Y = new int[] { 13, 313 };
        public int[] ctResult_Daiseikou_Loop_X = new int[] { 0, 0 };
        public int[] ctResult_Daiseikou_Loop_Y = new int[] { 13, 313 };
        public int[] Result_Hukidashi_X = new int[] { 220, 220 };
        public int[] Result_Hukidashi_Y = new int[] { 350, 650 };

        public int Result_Flower;
        public int Result_Rainbow_Ptn;
        public int Result_Daiseikou_In;
        public int Result_Daiseikou_Loop;
        public int Result_Normal_Loop;
        public int Result_Clear_Loop;
        public int Result_In;
        public int Result_Failed_Loop;
        public int Result_Oukan_Clear;
        public int Result_Oukan_FullCombo;
