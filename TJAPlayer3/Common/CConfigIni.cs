...
namespace TJAPlayer3
{
	internal class CConfigIni : INotifyPropertyChanged
	{
        ...
        // 各画像の表示・非表示設
        public bool ChangeNewSkin;
        public bool Change2PSkin;
...
//			this.nASIOBufferSizeMs = 0;					// #24820 2012.12.25 yyagi 初期値は0(自動設定)
	...
	//------------------------------
            ...
            sw.WriteLine("; スキンver画像 (0:OFF, 1:ON)");
            sw.WriteLine("ChangeNewSkin={0}", ChangeNewSkin ? 1 : 0);
            sw.WriteLine("; スキン2P画像 (0:OFF, 1:ON)");
            sw.WriteLine("; スキン画像 (0:OFF, 1:ON)");
            sw.WriteLine("Change2PSkin={0}", Change2PSkin ? 1 : 0);
            ...
            */
            ...
            sw.WriteLine("{0}={1}", nameof(真打), 真打 ? 1 : 0);
							...
							if( strArray.Length == 2 )
							{
								...
								switch( unknown )
								{
									...
									case Eセクション種別.PlayOption:
										{
                                            if (str3.Equals("ChangeNewSkin"))
                                            {
                                                ChangeNewSkin = C変換.bONorOFF(str4[0]);
                                            }
                                            if (str3.Equals("Change2PSkin"))
                                            {
                                                Change2PSkin = C変換.bONorOFF(str4[0]);
                                            }
                                            ...
                                            */
                                            ...
                                            else if(str3.Equals(nameof(真打)))
                                            {
                                                真打 = C変換.bONorOFF(str4[0]);
                                            }
											continue;
										}
									//-----------------------------
